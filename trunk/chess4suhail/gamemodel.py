...
class Game(db.Model):
  ...
  # Various strings are valid: chess, blitz-5, blitz-10, blitz-15
  ...
  def get_color_as_string(self):
    ...
    return '\xd8\xa3\xd8\xa8\xd9\x8a\xd8\xb6' if color == WHITE else '\xd8\xa3\xd8\xb3\xd9\x88\xd8\xaf'
  ...
  def to_dict(self, user):
    ...
    elif self.game_type == GAME_TYPE_BLITZ_15:
      result['time_limit'] = 15
  ...
  def get_outcome_as_string(self):
    ...
    if self.is_victory(user):
      return '\xd8\xb1\xd8\xa8\xd8\xad' #win
    elif self.is_loss(user):
      return '\xd8\xae\xd8\xb3\xd8\xa7\xd8\xb1\xd8\xa9'
    else:
      return '\xd8\xaa\xd8\xb9\xd8\xa7\xd8\xaf\xd9\x84' #draw
...
def relative_string(elapsed):
  ...
  if elapsed < 2 * 60:
    result = '\xd9\x85\xd9\x86 \xd8\xaf\xd9\x82\xd9\x8a\xd9\x82\xd8\xa9'
  elif elapsed < 60*60:
    result = ' \xd9\x85\xd9\x86 %d \xd8\xaf\xd9\x82\xd8\xa7\xd9\x8a\xd9\x82' % (elapsed/60)
  elif elapsed < 2 * 60 * 60:
    result = '\xd9\x85\xd9\x86 \xd8\xb3\xd8\xa7\xd8\xb9\xd8\xa9'
  elif elapsed < 10 * 60 * 60:
    result = ' \xd9\x85\xd9\x86 %d \xd8\xb3\xd8\xa7\xd8\xb9\xd8\xa7\xd8\xaa' % (elapsed/(60*60))
  elif elapsed < 24 * 60 * 60:
    result = ' \xd9\x85\xd9\x86 %d \xd8\xb3\xd8\xa7\xd8\xb9\xd8\xa9' % (elapsed/(60*60))
  elif elapsed < 48 * 60 * 60:
    result = '\xd9\x85\xd8\xa8\xd8\xa7\xd8\xb1\xd8\xad'
  elif elapsed < 48 * 60 * 60* 10:
    result = '\xd9\x85\xd9\x86 %d \xd8\xa3\xd9\x8a\xd8\xa7\xd9\x85' % (elapsed/(24 * 60 * 60))
  else:
    result =  '\xd9\x85\xd9\x86 %d \xd9\x8a\xd9\x88\xd9\x85' % (elapsed/(24 * 60 * 60))
  return result
